...
public class CounterClass extends CountDownTimer {
	 ...
	 * @param firstVibration
	 *            When first vibration should be start <br>
	 *            set to 0 to not run <br>
	 *            first vibration
	 * @param secondVibration
	 *            When second vibration should be start<br>
	 *            set to 0 to not run <br>
	 *            second vibration
	 * @param vibrationTime
	 *            Time for run each vibration <br>
